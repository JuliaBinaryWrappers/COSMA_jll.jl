...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import COSMA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0efae8bf-39e6-5d65-b05d-c8947f4cee2a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "COSMA", artifacts_toml) for e in artifacts["COSMA"]]
...
if best_platform === nothing
    @debug("Unable to load COSMA; unsupported platform $(triplet(platform_key_abi()))")
else
