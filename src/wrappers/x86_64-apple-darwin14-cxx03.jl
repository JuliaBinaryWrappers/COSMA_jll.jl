# Autogenerated wrapper script for COSMA_jll for x86_64-apple-darwin14-cxx03
...
const cosma_splitpath = ["lib", "libcosma.dylib"]
...
const cosma = "@rpath/libcosma.dylib"


# Relative path to `grid2grid`
const grid2grid_splitpath = ["lib", "libgrid2grid.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const grid2grid = "@rpath/libgrid2grid.dylib"
